...
import { resolveCanvasImageUrl, resolveCanvasMipUrl } from './AssetPathResolver';
...
describe('resolveCanvasImageUrl', () => {
  it('resolves an asset identity at call time without persisting cache paths', () => {
    ...
    expect(resolveCanvasMipUrl(scene, item, 2048)).toBe('refcanvas-asset://asset/asset%20id?variant=mip&edge=2048&v=3');
  });
});
