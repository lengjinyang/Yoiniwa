...
export function worldToImageSource(item: BoardItem, point: Point): Point {
...
export function imageSourceToWorld(item: BoardItem, point: Point): Point {
...
export function pointToAnchor(point: Point, anchor: VisualNoteAnchor, images: readonly BoardItem[]): Point {
...
function pointFromAnchor(point: Point, anchor: VisualNoteAnchor, images: readonly BoardItem[]): Point {
  if (anchor.type === 'scene') return point;
  const image = images.find((item) => item.id === anchor.imageId);
  return image ? imageSourceToWorld(image, point) : point;
}

export function markWorldPoints(mark: VisualMark, images: readonly BoardItem[]): VisualNotePoint[] {
...
export function markWorldBounds(mark: VisualMark, images: readonly BoardItem[]) {
...
export function moveMarkInWorld(mark: VisualMark, images: readonly BoardItem[], deltaX: number, deltaY: number): VisualMark {
